...
namespace WildMini
{
    class WM_API WMFile : public WMRefCounter
    {
    public:
        enum class OpenMode
        {
        ...
        static WMSharedPtr<WMFile> Open(const std::wstring& path, WMFile::AccessMode accessMode, WMFile::OpenMode openMode, bool binary);
        static WMSharedPtr<WMFile> OpenText(const std::wstring& path, WMFile::AccessMode accessMode, WMFile::OpenMode openMode);
        static WMSharedPtr<WMFile> OpenBinary(const std::wstring& path, WMFile::AccessMode accessMode, WMFile::OpenMode openMode);
